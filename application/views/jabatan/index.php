                            ...
                            <?php foreach ($jabatan as $b) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='javascript:void(0)' class="del_jabatan btn btn-sm btn-danger" data-kode="<?= $b['id']; ?>"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
            ...
            <form action="<?= base_url('Jabatan/tambah'); ?>" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Ketik Jabatan" required>
                    </div>
                </div>
            ...
            <form action="<?= base_url('Jabatan/edit'); ?>" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="jabatanedit" name="jabatanedit" placeholder="Ketik Jabatan" required>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
...
<script>
    ...
    $(document).ready(function() {
        $(document).on('click', '.del_jabatan', function(event) {
            event.preventDefault();
            let kode = $(this).attr('data-kode');
            let delete_url = "<?= base_url(); ?>/Jabatan/delete/" + kode;
