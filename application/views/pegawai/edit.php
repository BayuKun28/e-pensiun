                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?= $pegawai['nama_pegawai'] ?>" class="form-control" id="nama_pegawai" name="nama_pegawai" placeholder="Ketik Nama Pegawai" required>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?= $pegawai['nip']; ?>" class="form-control" id="nip" name="nip" placeholder="Ketik NIP" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Tanggal Lahir:</label>
                                            <div class="input-group date" id="tgl_lahirdata" data-target-input="nearest">
                                                <input type="text" value="<?= $pegawai['tgl_lahir']; ?>" id="tgl_lahir" name="tgl_lahir" class="form-control datetimepicker-input" data-target="#tgl_lahirdata" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="pangkat" name="pangkat" class="itemPangkat form-control select2" style="width: 100%;" required>
                                                <option value="<?= $pegawai['idpangkat']; ?>" selected> <?= $pegawai['pangkat']; ?> </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="alamat" id="alamat" class="form-control" cols="30" rows="4" required><?= $pegawai['alamat']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
